...
// #define SPECIALDETAIURL @"http://api.liwushuo.com/v1/collections/%@/posts?channel=104&limit=%@&offset=%@"
    NSString *url = [NSString stringWithFormat:@"http://api.liwushuo.com/v1/collections/%@/posts?channel=104&limit=%@&offset=%@",[NSNumber numberWithInteger:_totalModel.identity],[NSNumber numberWithInteger:_totalModel.posts_count],@0];
